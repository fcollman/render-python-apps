...
class SplitStack(RenderModule):
    ...
    def run(self):
        ...
        for k,(xc,yc) in enumerate(zip(xx.ravel(),yy.ravel())):
                ...
                tforms = [tform1,tform2,tform3]

                outstack = stack + "_%d"%k
                tilespecs = []
                ...
                for z in zvalues:
                    ...
                    mml = renderapi.tilespec.MipMapLevel(level,imageUrl=imageUrl)
